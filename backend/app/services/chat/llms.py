...
def get_result_from_llms(
    ...
    try:
        ...
        SYSTEM_PROMPT = f"""
            ...
            9. if user ask about the number then analyze the context and give the results.
        ...
        if stream:
            ...
            try:
                ...
                return response.content if response.content else "No result generated."
            except Exception as e:
                print("Error invoking LLM:", str(e))
                raise HTTPException(status_code=500, detail="Error invoking LLM: " + str(e))
